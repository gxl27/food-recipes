...
<x-card class="p-10 max-w-lg mx-auto mt-24">
  <header class="text-center">
    <h2 class="text-2xl font-bold uppercase mb-1">Direction</h2>
    <p class="mb-6">Add a new direction to {{ $recipe->name }}</p>
  </header>

  <form method="POST" action="{{ route('directions.store', ['recipe' => $recipe->id]) }}">
    @csrf
    <div class="mb-6">
